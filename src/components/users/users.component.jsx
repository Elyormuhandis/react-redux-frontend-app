...
const Users = () => {
  ...
  const { users, roles, role, loading } = useSelector((state) => state.user);
    ...
    <div className='users'>
      ...
      <div className='users__header'>
        ...
        <div className='users__sort'>
          ...
          <button className='dashboard-btn' onClick={formToggeHandler}>
            YARATISH
          </button>
        </div>
      </div>
      ...
      <table className='users__table'>
        <thead className='users__table-header'>
          <tr>
            ...
            <th>Toifasi</th>
            <th>Statusi</th>
            <th style={{ textAlign: 'center' }}>O'zgartirish</th>
